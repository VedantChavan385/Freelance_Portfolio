  ...
  return (
    <div className={`flex flex-col gap-2 w-full text-left select-none ${className}`}>
      ...
      <textarea
        ...
        onChange={onChange}
        required={required}
        className={`w-full bg-[#101010] text-[#E1E0CC] border rounded-lg px-4 py-3 text-sm sm:text-base font-light placeholder-zinc-600 focus:outline-none transition-colors duration-300 resize-none ${
